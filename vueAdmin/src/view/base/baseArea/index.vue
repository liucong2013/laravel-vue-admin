  ...
  <div>
    ...
    <div class="search-term">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline">
        <el-form-item>
          <el-input v-model="searchInfo.shortname" placeholder="简称" clearable :style="{ width: '100%' }"></el-input>
        </el-form-item>
    ...
    <el-dialog :before-close="closeDialog" :visible.sync="dialogFormVisible" title="表单操作">
      <el-form ref="elForm" :model="formData" :rules="rules" size="mini" label-width="100px" label-position="left">
        <el-form-item label="父id" prop="title">
          <el-input v-model="formData.parent_id" placeholder="请输入父id" clearable
        ...
        <el-form-item label="全称" prop="title">
          <el-input v-model="formData.merger_name" placeholder="请输入全称" clearable
                    :style="{ width: '100%' }"></el-input>
        </el-form-item>
        <el-form-item label="层级 0 1 2 省市区县" prop="title">
          <el-input v-model="formData.level" placeholder="请输入层级 0 1 2 省市区县" clearable
                    :style="{ width: '100%' }"></el-input>
        </el-form-item>
        <el-form-item label="拼音" prop="title">
          <el-input v-model="formData.pinyin" placeholder="请输入拼音" clearable :style="{ width: '100%' }"></el-input>
        </el-form-item>
        <el-form-item label="长途区号" prop="title">
          <el-input v-model="formData.code" placeholder="请输入长途区号" clearable
                    :style="{ width: '100%' }"></el-input>
        </el-form-item>
        <el-form-item label="邮编" prop="title">
          <el-input v-model="formData.zip_code" placeholder="请输入邮编" clearable
                    :style="{ width: '100%' }"></el-input>
        </el-form-item>
        <el-form-item label="首字母" prop="title">
        ...
        <el-form-item label="纬度" prop="title">
